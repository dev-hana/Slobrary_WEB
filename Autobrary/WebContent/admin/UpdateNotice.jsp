...
<br><br>
<form id="frm" action="UpdateNoticeProc.jsp" method="post" >
<table style="margin-left:auto; margin-right:auto">
		<tr>
			<td style="color:#042759">작성자 : <%=ntBean.getAdmin_id() %></td>
		</tr>
		<tr>
			<td style="color:#042759">등록번호 : <%=ntBean.getNum() %></td>
		</tr>
        <tr>
            <td>제목 <input type="text" id="title" name="title" style="width:1450px" value="<%=ntBean.getName() %>"></td>
        </tr>
        <tr>
            
            <td>
                <textarea rows="10" cols="30" id="ir1" name="content" style="width:1500px; height:500px; text-align:center;">
                <%=ntBean.getContent() %>
                </textarea>
            </td>
        </tr>
...
<input type="hidden" id="id" name="id" value=<%=ntBean.getNum() %> />
</form>
